...
class ScanMsg:
    ...
    def __init__(self):
        ...
        - 3 integer variables to keep track of where obstacles exist.
        ...
        self.fwd = {
            0: .25, 1: 0, 10: 0, 11: 0, 100: 0.1, 101: 0, 110: 0, 111: 0}
        self.dbgmsg = {0: 'Move forward', 1: 'Veer right', 10: 'Veer right', 11: 'Veer right',
                       100: 'Veer left', 101: 'Veer left', 110: 'Veer left',
                       111: 'Veer right'}
    ...
    def movement(self, nn):
        ...
        self.msg.angular.z = nn.angular.z
        self.msg.linear.x = nn.linear.x
        rospy.loginfo(nn)
...
def listener():
    '''
    Initializes node, creates subscriber, and states callback function.
    '''
    rospy.init_node('navigation_sensors')
    rospy.loginfo("Subscriber Starting")
    sub = rospy.Subscriber('/cmd_vel_mux/input/navi', Twist, call_back)
    rospy.spin()
